...
var ShareInteractionResponseSchema = z.object({ success: z.boolean() });
...
var ShareLinkResponseSchema = z.object({
  success: z.boolean(),
...
var InviteUserEmbeddedRequestSchema = z.object({
  user_id: z.string(),
  content: z.string().min(0).max(1024).optional()
});
var GetUserRequestSchema = z.object({ id: z.string().max(64) });
